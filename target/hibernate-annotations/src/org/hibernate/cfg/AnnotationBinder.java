...
//		Changes made to ignore optional flag because Dialects handle this along with Table and Index class
...
//		);
		...
		FkSecondPass secondPass = new FkSecondPass(
				value, columns,
				unique, //cannot have nullabe and unique on certain DBs like Derby
				propertyHolder.getEntityOwnerClassName(),
				path, mappings
		);
		if (inSecondPass) {
